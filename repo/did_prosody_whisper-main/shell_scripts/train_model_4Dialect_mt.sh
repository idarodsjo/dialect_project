...
label_column=cardinal_four # change as necessary (USED TO BE dialect_region)

unmod_model_output_dir=/home/idatro/repo/did_prosody_whisper-main/model_output_mt/
low_pass_model_output_dir=/home/idatro/repo/did_prosody_whisper-main/model_output/low_pass
monotonize_model_output_dir=/home/idatro/repo/did_prosody_whisper-main/model_output/monotonize
output_dirs=($unmod_model_output_dir $low_pass_model_output_dir $monotonize_model_output_dir)

unmod_audio_column=audio_path   #not sure ab this, but think its correct
...
# Only performs training on unmodified data
for ((i=0 ; i < 1 ; i++)); do
    model=${output_dirs[$i]}
    ...
    CUDA_VISIBLE_DEVICES=0,1 deepspeed /home/idatro/repo/did_prosody_whisper-main/whisper_did_training.py \
        --deepspeed /home/idatro/repo/did_prosody_whisper-main/original_ds_config.json \
        ...
        --do_regression False \
        --regression_lat_column latitude \
        --regression_lon_column longitude \
